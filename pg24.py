...
doc = SimpleDocTemplate('routine_67O.pdf',
                        pagesize=A4,
                        topMargin=14*mm,
                        bottomMargin=14*mm,
                        leftMargin=12*mm,
...
def row(time_str, task_str, tag_label, tag_colors, is_namaz=False):
    tc, txt = tag_colors
    row_bg = GREEN_BG if is_namaz else WHITE
    return [time_str, task_str, tag_label, tc, txt, row_bg, is_namaz]
...
days = [
    {
        ...
        'rows': [
            ...
            ('১৩:৪৫–১৪:৩০', 'Compiler Design – CSE313 · KT-318(B) (UH) — শেষাংশ',    'Class',  TAG_CLASS,   False),
            ...
            ('মাগরিব+৫ মিনিট','মাগরিব নামাজ + দোয়া',                                'মাগরিব', TAG_NAMAZ,   True),
    ...
    },
    {
        ...
        'rows': [
            ...
            ('১:৩০',         'যোহর নামাজ + দোয়া',                                                        'যোহর',   TAG_NAMAZ,   True),
            ('১৩:৪৫–১৪:৩০', 'DBMS Lab CSE312(O2) · G1-016 | Compiler Lab CSE314(O1) · G1-020 — শেষাংশ', 'Lab',    TAG_CLASS,   False),
    ...
    },
    {
        ...
        'rows': [
            ...
            ('০৫:০০–০৭:৩০', 'ঘুম (২য় শিফট)',                                             'ঘুম',     TAG_SLEEP,   False),
            ('০৭:৩০–০৮:০০', 'নাস্তা',                                                    'নাস্তা',  TAG_BREAK,   False),
            ('০৮:০০–১:৩০',  'Deep Work — Project / Complex Topics (class নেই সকালে)',    'Deep Work',TAG_DW,    False),
            ('১:৩০',         'যোহর নামাজ + দোয়া',                                        'যোহর',    TAG_NAMAZ,   True),
            ('১৩:৫০–১৪:৩০', 'Compiler Design – CSE313 · KT-303 (UH) — শুরু',             'Class',   TAG_CLASS,   False),
            ('১৪:৩০–১৬:০০', 'Numerical Methods – CSE226 · KT-303 (MMR)',                  'Class',   TAG_CLASS,   False),
            ('৫:১৫ (বিরতিতে)','আসর নামাজ — class ফাঁকে পড়ে নিন',                        'আসর',     TAG_NAMAZ,   True),
